    ...
    <AuthenticatedLayout :nav-status="false">
        <main class="container max-w-4xl" style="max-width: 1200px;">
            <article class="flex gap-x-12 text-white">
                <div
                    class="mx-auto mt-6 max-w-[500px] flex-shrink-0 sticky top-[40px] self-start w-[315px]">
                    <figure>
                    ...
                    <figcaption class="mt-4">
                        ...
                        <div class="text-white/70 bg-panel-800 hover:bg-panel-700 transition-colors duration-300 p-3 my-4 rounded-xl">
                ...
                <main class="">
                    <div class="col-span-8">
                        <section class="max-w-none p-0 flex-1 mb-3 ">
                            <div
                                class="hidden lg:flex justify-between mb-6 text-white/70 bg-panel-800 hover:bg-panel-700 transition-colors duration-300 py-3 px-2 rounded">
                                <a :href="route('article.index')"
                                   class="font-semibold normal-case rounded-lg">
                                            ...
                                            <div class="px-4 md:flex-1 md:px-0">
                                                <header class="mb-4">
                                                    <div class="flex items-center">
                                                        <!--REACTION-->
                                                            <button :title="reacted ? 'Want to like this article for future reference?':'Want to like this article for future reference?'"
                                                                    :class="reacted ? 'rounded-full px-1 flex items-center justify-center bg-[#f6b7cb] mr-4':'rounded-full px-1 flex items-center justify-center bg-white/10 mr-4'"
                        ...
                        <section class="mt-3 py-6 px-4 text-white/70 dark:bg-[#151f32] rounded">
                            <div id="replies">
