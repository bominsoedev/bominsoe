<template>
    <Head/>
    <AuthenticatedLayout :classes="'min-w-screen-xl'" :nav-status="ture">
        <main class="min-w-4xl ">
            <div class="container mx-auto flex flex-col flex-col-reverse justify-between md:flex-row lg:gap-x-10">
                <div class="">
                ...
                <div></div>
                <!-- drawer component -->
                <div id="drawer-form" class=" fixed bottom-0 inset-x-0 z-40 w-full p-4 transition-transform bg-white dark:bg-gray-800 transform-none"
                    ...
                    <h5 id="drawer-label" class="inline-flex items-center mb-6 text-base font-semibold text-gray-500 uppercase dark:text-gray-400">
                        <svg class="w-5 h-5 mr-2" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg>New event</h5>
                    ...
                    <form action="#" class="mb-6">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="description" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg
                             border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write event description..."></textarea>
                        </div>
