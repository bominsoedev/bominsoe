            ...
            <div class="bg-panel-800 h-72 w-full mt-6">
                ...
                >
                    ...
                    <div
                        ...
                        class="flow-root p-3 border rounded-lg border-[#223c68] mb-2"
                    >
                        <h3
                            class="text-sm font-medium truncate dark:text-white"
                        >
                            <time>{{ key }}</time>
                        </h3>
                            ...
                            <li v-for="a in article" class="py-2">
                                ...
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <p
                                            class="text-lg font-bold font-medium truncate dark:text-white"
                                        >
                                            {{ a.title }}
                                        </p>
                                        <div
                                ...
                                <div
                                    class="flex justify-between items-center mt-2 px-8"
                                >
                                    <div class="">
                                        <span class="text-2xs">
                                            <Time
