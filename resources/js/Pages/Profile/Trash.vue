    ...
    <AuthenticatedLayout :classes="'max-w-screen-xl'" :nav-status="true">
        ...
        <template #sidebar>
            ...
            <SidebarLink :active="route().current('user.trash', $page.props.auth.user)"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    class="bi bi-recycle text-gray-400 mr-3" viewBox="0 0 16 16">
                    <path
        ...
        <div class="">
            <div class="w-full profile-dark border border-[#223c68] rounded" style="height: 815">
                <div class="h-96 overflow-hidden relative p-3">
                    <div class="">
                        <a target="_blank" :href="'/storage/ProfileAttachment/' +
                            ...
                            <div class="">
                                <div class="-space-x-3">
                                    <img :title="$page.props.auth.user.username"
                                        ...
                                        src="/Images/Icon/S.svg" alt="Profile image" />
                                    <img :title="$page.props.auth.user.username"
        ...
        ">
            ...
            <div class="bg-panel-800 h-72 w-full mt-6">
                ...
                <div
                    class="w-full max-w-full p-4 border border-[#223c68] rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div class="flex">
                            <div class="flex items-center mr-4">
                                ...
                                <label for="disabled-checkbox"
                                       class="ml-2 text-sm font-medium text-gray-400 dark:text-gray-500">Select All</label>
                            </div>
                        </div>
                       <div>
<!--                           <h5 class="text-xl font-bold leading-none  dark:text-white">Latest Customers</h5>-->
                    ...
                    <div class="flow-root p-4 border rounded-lg border-[#223c68] mb-2 " v-for="(article,key) in articles" >
                        <h3 class="text-sm font-medium  truncate dark:text-white">
                            {{ key }}
                        </h3>
                        <ul role="list" class="divide-y divide-gray-200 dark:divide-gray-700"  >
                            <li class="py-3 sm:py-4 " v-for="a in article">
                                ...
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div data-dial-init class="flex" >
                                        <div  class="flex items-center mr-4 space-x-2 invisible" data-popover id="popover-click">
                                          <div class=" w-52 justify-start bg-gray-700 rounded-xl " >
                                              <div class="p-2 hover:rounded-lg hover:bg-gray-500" type="button" >
                                                  <a :href="route('user.trash', $page.props.auth.user)" >Restore</a>
                                              </div>
                                              <div class="p-2 hover:rounded-lg hover:bg-gray-500">
                                                  <a  class="text-md">Delete</a>
                                              </div>
                                          </div>
                                       </div>

                                        <button type="button" data-popover-target="popover-click" data-popover-trigger="click"  data-popover-placement="left"
                                                class="flex items-center justify-center group
                                                rounded-full w-14 h-14 dark:bg-blue-600 hover:bg-gray-700
        ...
        <div v-if="showFileUpload" class="flex justify-center absolute duration-300 w-full z-[1000]">
            <div class="rounded-lg shadow-xl dark:bg-gray-800 lg:w-1/2">
                ...
                <div class="flex w-full justify-start px-5 pb-5 space-x-4" :data-value="$page.props.auth.user.uuid">
                    ...
                    <div class="" data-v-2836fdb5-s="">
                        <button
                            class="btn flex items-center w-full rounded-xl border-transparent bg-grey-500 normal-case text-grey-800 hover:bg-black/10 dark:bg-blue/13 dark:text-white dark:hover:border-transparent dark:hover:bg-blue/20 px-4 py-2 duration-300"
                            data-label="$page.props.auth.user.uuid" @click.prevent="
                                this.isProfile
