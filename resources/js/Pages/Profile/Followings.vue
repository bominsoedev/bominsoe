                ...
                <div class="">
                    <div
                        ...
                        <ul class="flex flex-wrap -mb-px">
                            <li class="mr-2">
                                <TabLink :active="route().current('profile.information', $page.props.auth.user)" :href="route('profile.information', $page.props.auth.user)">
                                    Article
                                </TabLink>
                            </li>
                            <li class="mr-2">
                                <TabLink :active="route().current('user.index',$page.props.auth.user)" :href="route('user.index',$page.props.auth.user)">
                                    Followers
                                </TabLink>
                            </li>
                        </ul>
