                    ...
                    <td>
                        <div class="flex justify-center">
                            <button :data-modal-target="category.uuid"
                                    ...
                                    class="block text-white rounded-lg text-sm text-center"
                                    type="button">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                ...
                                <div class="relative w-full max-w-md max-h-full">
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="rounded-lg px-6 py-4 text-sm dark:bg-gray-800 bg-white">
                                            ...
                                            <form @submit.prevent="form.put(route('category.update',category))">
                                                <div class="mt-4 pl-2">
                                                    <InputLabel for="category" value="Category Name"/>
                                                    <div class="mt-1">
                                                        <div class="my-2">
                            ...
                            <form @submit.prevent="form.delete(route('category.destroy',category))">
