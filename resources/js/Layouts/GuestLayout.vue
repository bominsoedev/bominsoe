    ...
    <div id="root" class="home-dark">
        <div class="flex-1">
            ...
            <div class="relative rounded-b-[28px]">
                <div class="">
                    <nav v-if="canLogin"  class="fixed z-50 w-full min-w-screen-xl py-4 lg:py-3 border-b border-gray-800 bg-[#151f32]"
                         style="height: 60px">
                        <div class="relative grid w-full max-w-nav grid-cols-8 items-center gap-x-4 px-5">
                            ...
                            <div
                                ...
                                <div v-if="$page.props.auth" class="inline-flex">
                                    ...
                                    <NavLink :active="route().current('article.index')" :href="route('article.index')">
                                        <svg class="bi bi-postcard" fill="currentColor" height="16" viewBox="0 0 16 16"
                                    ...
                                    <NavLink :active="route().current('category.index')" :href="route('category.index')">
                                        <svg class="bi bi-bezier2" fill="currentColor" height="16" viewBox="0 0 16 16"
                                             width="16" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <template v-else>
                                    ...
                                    >
                                        <div class="flex items-center space-x-2">
                                            <svg class="bi bi-box-arrow-in-right" fill="currentColor" height="16"
                                                 viewBox="0 0 16 16"
                                                 width="16" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                        ...
                                        Log in
                                            ...
                                            <span class="block text-[.6rem] font-normal text-white/50"> //:login</span>
                                        </div>
                                    </Link
                                    >
                                    <Link
                                    ...
                                    >
                                        ...
                                        Register
                                            ...
                                            <span class="block text-[.6rem] font-normal text-white/50"> //:register</span>
                                        </div>
                                    </Link
                                    >
                                </template>
                    ...
                    <section class="flex min-w-screen-xl justify-center">
                        <ToastList></ToastList>
                        <div class="mb-32 mt-20 w-full max-w-screen-xl px-12 text-gray-400">
                                <div class="flex">
                                    <div class="w-full">
                                        <slot/>
                                    </div>
