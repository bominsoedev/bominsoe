<template>
    <x-pane class="bg-gray-100 mt-3">
                ...
                <div class="flex space-x-2">
                    <div class="mr-2">
                        <img loading="lazy" :src="'/storage/ArticleAttachment/'+comment.photo.unique_name" alt=""
                             width="30"
                             class="lazy object-cover lazyloaded rounded-full" style="height: 28px">
                    </div>
                                   ...
                                   class="inline-flex text-xs mr-2 rounded-lg items-center font-semibold normal-case text-grey-800 transition-all dark:text-grey-600 px-3 py-1 btn btn-dark-blue hover:bg-blue/15">
                                    <svg width="12" height="13" viewBox="0 0 12 13" class="mr-1">
                                        <path fill="#78909C" fill-rule="evenodd" stroke="#78909C" stroke-width=".5"
                                              d="M6.96 1.877L4.34.542l.435 1.413a5.196 5.196 0 0 0-3.161 2.64C.32 7.133 1.267 10.2 3.73 11.455s5.5.218 6.794-2.32a5.203 5.203 0 0 0 .316-3.989l-1.145.369c.338.955.29 2.087-.22 3.086-.99 1.944-3.308 2.735-5.194 1.774-1.887-.962-2.61-3.302-1.619-5.246a4.085 4.085 0 0 1 2.461-2.045l.46 1.493 1.377-2.7z"></path>
                                    </svg>
                                    Reply
                                </a>
        ...
        <div class="vfm vfm--inset vfm--fixed vfm--prevent-none" data-js="reply-modal" height="auto" data-v-2836fdb5=""
             style="z-index: 1000;"><!--v-if-->
            <div class="vfm__container vfm--absolute vfm--inset vfm--outline-none flex mx-auto dark"
                 aria-expanded="true" role="dialog" aria-modal="true" tabindex="-1" data-v-2836fdb5="" style="">
                <div
                    ...
                    <div class="flex py-4 px-6 md:px-8" data-v-2836fdb5-s="">
                        <div class="flex-1" data-v-2836fdb5-s="">
                            <form class="text-sm" data-v-2836fdb5-s="">
                                <div class="mb-2 flex items-center" data-v-2836fdb5-s="">
                                        ...
                                        <g fill="none" fill-rule="evenodd" stroke="none" stroke-width="1"
                                           data-v-2836fdb5-s="">
                                            <g id="Group" class="fill-current"
                                               transform="translate(0.000000, -336.000000)" data-v-2836fdb5-s="">
                                                <path
                                    ...
                                    <p class="font-semibold" data-v-2836fdb5-s="">
                                        Reply to
                                        <strong
                                            class="uppercase text-blue" data-v-2836fdb5-s="">
