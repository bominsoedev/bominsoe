<template>
    <x-pane class="bg-gray-100 mt-3">
        ...
        <CommentReply :comment="comment" :is-open="this.isOpen" :is-edit="isEdit"></CommentReply>
<!--        <div class="vfm vfm&#45;&#45;inset vfm&#45;&#45;fixed vfm&#45;&#45;prevent-none" v-if="isOpen" height="auto"-->
<!--             data-v-2836fdb5="" style="z-index: 1000;">&lt;!&ndash;v-if&ndash;&gt;-->
...
<!--                            <form @submit.prevent="edit(comment)" class="text-sm" data-v-2836fdb5-s="">-->
